...
#vcffilter -s -f "AB > 0.25 & AB < 0.75 | AB < 0.01" populations.snps.recode.vcf > populations.snps.recode.vcf
...
#vcffilter -f "SAF / SAR > 100 & SRF / SRR > 100 | SAR / SAF > 100 & SRR / SRF > 100" -s populations.snps.recode.vcf > populations.snps.recode.vcf
...
#vcffilter -f "QUAL / DP > 0.25" populations.snps.recode.vcf > populations.snps.recode.vcf
...
#vcffilter -f "MQM / MQMR > 0.9 & MQM / MQMR < 1.05" populations.snps.recode.vcf > populations.snps.recode.vcf
```

#step2: visualize missing data by sample. Run this code on the cluster as your last step after exporting an unfiltered vcf file from STACKS populations. Check out the visualizations and make decision on which samples to keep for downstream analysis.
